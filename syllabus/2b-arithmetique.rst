...
La deuxième astuce est que le bit de poids fort de la représentation binaire continent le signe du nombre réel, `1` pour les nombres négatif et `0` pour les nombres positifs. Même si la notation en complément à deux ne contient pas de bit explicite de signe, tous les nombres entiers négatifs ont aussi leur bit de poids fort à `1`.
